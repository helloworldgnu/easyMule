/* 
 * $Id: ListViewWalkerPropertySheet.cpp 4483 2008-01-02 09:19:06Z soarchin $
 * 
...
void CListViewWalkerPropertySheet::OnPrev()
{
	...
	CObject* pPrev = m_pListCtrl->GetPrevSelectableItem();
...
void CListViewWalkerPropertySheet::OnNext()
{
	...
	CObject* pNext = m_pListCtrl->GetNextSelectableItem();
...
CObject* CListCtrlItemWalk::GetCurrSelectableItem()
{
	ASSERT( m_pListCtrl != NULL );
	...
	int iItemCount = m_pListCtrl->GetItemCount();
	int iItem = m_pListCtrl->GetHotItem();
