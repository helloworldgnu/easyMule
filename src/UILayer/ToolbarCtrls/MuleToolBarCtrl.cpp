/* 
 * $Id: MuleToolBarCtrl.cpp 5877 2008-06-19 09:31:58Z huby $
 * 
...
void CMuleToolbarCtrl::Init(void)
{
	...
	lLen2 = _tcslen(GetResString(IDS_HELP_)) + 1;
	memcpy(cButtonStrings+lLen, GetResString(IDS_HELP_), lLen2*sizeof(TCHAR));
	lLen += lLen2;
	++m_buttoncount;
