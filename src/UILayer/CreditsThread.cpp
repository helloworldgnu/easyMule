...
void CCreditsThread::InitText()
{
	...
	*/
	...
	sTmp.Format(_T("03:00:%s"),GetResString(IDS_CAPTION));
	m_arCredits.Add(sTmp);
	sTmp.Format(_T("02:06:Version %s"),CGlobalVariable::GetCurVersionLong());
	m_arCredits.Add(sTmp);
	m_arCredits.Add(_T("01:06:Copyright (C) 2002-2008 VeryCD"));
	m_arCredits.Add(_T("S:50"));
	m_arCredits.Add(_T("02:00:VeryCD Teams"));
	m_arCredits.Add(_T("01:06:China: .o¦Ï§°¡ð.NET"));
	m_arCredits.Add(_T("01:06:aho~~aho~"));
	m_arCredits.Add(_T("S:05"));
	m_arCredits.Add(_T("01:06:Chocobo"));
	m_arCredits.Add(_T("S:05"));
	m_arCredits.Add(_T("01:06:GGSoSo"));
	m_arCredits.Add(_T("S:05"));
	m_arCredits.Add(_T("01:06:Huby"));
	m_arCredits.Add(_T("S:05"));
	m_arCredits.Add(_T("01:06:KERNEL1983"));
	m_arCredits.Add(_T("S:05"));
	m_arCredits.Add(_T("01:06:SearchDream"));
	m_arCredits.Add(_T("S:05"));
	m_arCredits.Add(_T("01:06:Soar"));
	m_arCredits.Add(_T("S:05"));
	m_arCredits.Add(_T("01:06:thilon"));
	m_arCredits.Add(_T("S:05"));
	m_arCredits.Add(_T("01:06:YunCheng"));
	m_arCredits.Add(_T("S:05"));
	m_arCredits.Add(_T("01:06:WangNa"));
	m_arCredits.Add(_T("S:05"));
	m_arCredits.Add(_T("01:06:nightsuns"));


	m_arCredits.Add(_T("S:50"));
	m_arCredits.Add(_T("02:04:UI Design"));
	m_arCredits.Add(_T("01:06:China: richy"));
	...
	m_arCredits.Add(_T("S:50"));
	m_arCredits.Add(_T("02:04:Part of easyMule is based on Kademlia:"));
	m_arCredits.Add(_T("S:5"));
