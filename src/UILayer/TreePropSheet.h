/*
 * $Id: TreePropSheet.h 5086 2008-03-21 08:46:39Z thilon $
 * 
...
public:
	...
	*/
	static BOOL SetPageIcon(CPropertyPage *pPage, LPCTSTR pszIconId);
...
protected:
	...
	*/
	...
	void ShowTreeItem(int n);
	void HideTreeItem(int n);
...
protected:
	static const UINT s_unPageAdvId;
	int m_iDispPageCount;
};
