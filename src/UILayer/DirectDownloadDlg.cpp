/* 
 * $Id: DirectDownloadDlg.cpp 4483 2008-01-02 09:19:06Z soarchin $
 * 
			...
			try
			{
				...
				if (pLink)
				{
					if (pLink->GetKind() == CED2KLink::kFile)
					{
						...
						//CGlobalVariable::downloadqueue->AddFileLinkToDownload(pLink->GetFileLink(), 
						//	(thePrefs.GetCatCount()==0)?0 : m_cattabs.GetCurSel() );
						CmdFuncs::AddFileLinkToDownload(pLink->GetFileLink(), (thePrefs.GetCatCount()==0)?0 : m_cattabs.GetCurSel());
