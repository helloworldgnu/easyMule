/* 
 * $Id: MiniMule.cpp 4483 2008-01-02 09:19:06Z soarchin $
 * 
...
void CMiniMule::UpdateContent(UINT uUpDatarate, UINT uDownDatarate)
{
	...
	SetElementHtml(_T("connected"), CComBSTR(CGlobalVariable::IsConnected() ? GetResString(IDS_YES) : GetResString(IDS_NO)));
