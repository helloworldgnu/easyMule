/* 
 * $Id: ClientList.h 9297 2008-12-24 09:55:04Z dgkang $
 * 
...
public:
	...
	void	Debug_SocketDeleted(CClientReqSocket* deleted,CUpDownClient* pOldClient=NULL,CClientReqSocket* pOldReqSocket=NULL) const;
