/* 
 * $Id: KademliaUDPListener.h 9297 2008-12-24 09:55:04Z dgkang $
 * 
...
namespace Kademlia
{
	...
	class CKademliaUDPListener : public CPacketTracking
	{
		...
		private:
			...
			void Process_KADEMLIA2_SEARCH_RES (const byte* pbyPacketData, uint32 uLenPacket, CKadUDPKey senderUDPKey);
