/* 
 * $Id: DataIO.cpp 9297 2008-12-24 09:55:04Z dgkang $
 * 
...
bool CKademlia::InitUnicode(LPBYTE pRes, DWORD dwSize)//HMODULE hInst)
{
	if (dwSize == sizeof _awcLowerMap)
	{
		memcpy(_awcLowerMap, pRes, dwSize);
