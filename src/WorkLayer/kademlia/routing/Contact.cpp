/* 
 * $Id: Contact.cpp 9297 2008-12-24 09:55:04Z dgkang $
 * 
...
CContact::~CContact()
{
	if (m_bGuiRefs)		
	{
		//PostMessage(CGlobalVariable::m_hListenWnd, WM_KAD_CONTACTREM, 0, (LPARAM)this);	
		UINotify(WM_KAD_CONTACTREM, 0, (LPARAM)this, this, true);
		RemoveMessageTag(this);
	}
}
...
void CContact::CheckingType()
{
	...
	PostMessage(CGlobalVariable::m_hListenWnd, WM_KAD_CONTACTREF, 0, (LPARAM)this);
}
