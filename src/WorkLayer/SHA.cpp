/* 
 * $Id: SHA.cpp 4483 2008-01-02 09:19:06Z soarchin $
 * 
 * ---------------------------------------------------------------------------
...
void CSHA::Finish()
{
	...
	_asm
	{
		...
		push	esi
		mov		ecx, this
		;  VC-yunchenn.chen[2007-07-05]: Ö§³ÖIntel compiler
		mov		esi, pCount
		mov		eax, [esi]
		mov		edx, [esi+4]
		pop		esi
		;  VC-yunchenn.chen[2007-07-05]: Intel compiler fail for below two clauses
