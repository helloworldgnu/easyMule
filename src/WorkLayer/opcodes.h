/* 
 * $Id: opcodes.h 9297 2008-12-24 09:55:04Z dgkang $
 * 
...
#define	UPLOAD_CHECK_CLIENT_DR	1536
#define	UPLOAD_CLIENT_DATARATE	2048		// uploadspeed per client in bytes - you may want to adjust this if you have a slow connection or T1-T3 ;)
...
#define OP_VC_STAT_HEADER2  0xe0	//VC STAT 
#define OP_VC_STARTUP_INFO  0x02
...
#define  FT_FILERENAME           0x37   // <bool>
...
#define  FT_SINGLEURLSOURCE      0x35   // <string>     // VC-SearchDream[2007-07-13]: Record HTTP/FTP Direct DownLoad URL 
#define  FT_FILESIZESTATUS	     0X36   // VC-Huby[2007-08-03]
#define  FT_FILENAME_CONFLICTED	 0x3B	
