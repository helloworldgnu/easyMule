/* 
 * $Id: Scheduler.cpp 4483 2008-01-02 09:19:06Z soarchin $
 * 
	...
	for (int ai=0;ai<16;ai++) {
		...
		switch (schedule->actions[ai]) {
			...
			case 5 :
				...
				break;
			case 6 :
				CGlobalVariable::downloadqueue->SetCatStatus(_tstoi(schedule->values[ai]),MP_STOP);
				break;
			case 7 :
				CGlobalVariable::downloadqueue->SetCatStatus(_tstoi(schedule->values[ai]),MP_RESUME);
				break;
		}
	}
}
