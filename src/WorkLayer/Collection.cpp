/* 
 * $Id: Collection.cpp 4483 2008-01-02 09:19:06Z soarchin $
 * 
...
void CCollection::WriteToFileAddShared(CryptoPP::RSASSA_PKCS1v15_SHA_Signer* pSignKey)
{
	...
	CGlobalVariable::sharedfiles->AddFileFromNewlyCreatedCollection(thePrefs.GetMuleDirectory(EMULE_INCOMINGDIR), sFileName);
}
