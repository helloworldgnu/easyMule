/*
 * $Id: MetaLinkQuerySocket.h 4483 2008-01-02 09:19:06Z soarchin $
 * 
...
// CMetaLinkQuerySocket 命令目标

class CMetaLinkQuerySocket : public CSendGetUrlReqSocket
{
public:
	CMetaLinkQuerySocket(CUrlSrcFromSvrMgr *pMgr, bool bStart);
	virtual ~CMetaLinkQuerySocket();
