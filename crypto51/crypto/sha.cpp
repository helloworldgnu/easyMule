s// sha.cpp - modified by Wei Dai from Steve Reid's public domain sha1.c
...
#define R(i) h(i)+=S1(e(i))+Ch(e(i),f(i),g(i))+_K[i+j]+(j?blk2(i):blk0(i));\
